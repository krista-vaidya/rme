...
the expected fraction of the original population at time 0 who have survived up to time $t$ and are still alive at time $t$; that is:
:::
...
which we can use to derive the hazard function for a given probability distribution (@thm-hazard1).
:::
