...
\\ &=  \frac {\deriv{\pi}\pi} {1-\pi} - \paren{\frac{\pi}{\sqf{1-\pi}} \cd \deriv{\pi}\paren{1-\pi}}
...
$$\oddsinv'(\odds) = \frac{1}{\sqf{1+\odds}}$$
:::
...
:::{#cor-deriv-invodds}
$$\oddsinv'(\odds) = \sqf{1-\oddsinv(\odds)}$$
:::
...
The **expit function** (@fig-expit-plot) of a log-odds $\eta$, also known as the **inverse-logit function** or **logistic function**, is the inverse-odds of the exponential of $\eta$:
