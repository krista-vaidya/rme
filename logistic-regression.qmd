...
\\ &=      \deriv{\vb} \sumin \P_{\vb}(Y_i=y_i|X_i=x_i)
\\ &=      \sumin \deriv{\vb} \P_{\vb}(Y_i=y_i|X_i=x_i)
\ea
$$

$$
\ba
\deriv{\vb} \P_{\vb}(Y_i=y_i|X_i=x_i) 
...
\ba
\llik_i'(\vb) 
   &= \cb{\vx_i y_i - \vx_i \expitf{\vx_i'\beta} }
\\ &= \vx_i \cb{ y_i - \expitf{\vx_i'\beta}}
\\ &= \vx_i \cb{ y_i - \inv{1+\expf{-\vx_i'\beta}}}
\ea
$${#eq-score-logistic}

---

Setting the dataset score function equal to 0 gives us:
